...
function renderWatchOutItem(text: string): React.ReactNode {
  ...
  // Bold first phrase up to first comma/period
...
const ExplanationPanel: React.FC = () => {
  ...
  const hasAny = hasBottomLine || hasRememberAs || hasWatchOut || hasHighYield || hasFullExplanation;
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5 max-h-[calc(100vh-8rem)]">
        ...
        {/* Remember It As */}
        {hasRememberAs && (
          <div className="explanation-section pl-3 border-l-2 border-primary/30">
            <h3 className="text-sm font-semibold mb-2 flex items-center gap-1.5">
