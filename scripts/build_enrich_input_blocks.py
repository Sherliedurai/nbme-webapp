#!/usr/bin/env python3
"""
Per-question Mehlman retrieval for blocks 2-10 → per-block enrichment input files.
Deterministic (code-driven grounding). Reads blocks2-10.merged.json + chunks.json.
Writes import/out/enrich_input_block<N>.json for N=2..10.
"""
...
for it in items:
    ...
    rec = {
        ...
        "source_explanation": it["source_explanation"], "retrieved": retrieve(it),
    }
